<div id="bg-isi"><h2>Module Kategori Berita - E-Learning</h2><br />
...
<br /><br />
<?php echo form_open_multipart('admin/simpankatberita');?>
<table width="520" cellpadding="2" cellspacing="1" class="widget-small">
<tr><td width="150" valign="top">Nama Kategori Berita</td><td width="10" valign="top">:</td><td><input type="text" name="nama" class="textfield" size="50" /></td></tr>
