...
<div id="bg-isi"><h2>Tes Soal Online</h2>
<div id="isi">
<?php
...
<?php
	...
	foreach($soal->result_array() as $jwb)
	{
		...
		$nomor++;
		echo "<td></td><td>
		<a href='".base_url()."index.php/admin/edit_soal/".$jwb['id_soal']."'><div class='pagingpage'><b>Edit</b></div></a>
		<a href='".base_url()."index.php/admin/hapus_soal/".$jwb['id_soal']."'><div class='pagingpage'><b>Hapus</b></div></a>
		</td></tr>";
	}
?>
</table>
