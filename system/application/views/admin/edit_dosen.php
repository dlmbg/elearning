...
<tr><td width="150">pendidikan_terakhir</td><td width="10">:</td><td><input type="text" name="pend_terakhir" class="textfield" size="80" value="<?php echo $pend_terakhir; ?>" required></td></tr>
