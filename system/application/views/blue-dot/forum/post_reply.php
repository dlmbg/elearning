...
<form method="post" action="<?php echo base_url(); ?>forum/save_reply">
<table  width="100%" bgcolor="#cbe6ff" cellspacing="0" border="0" cellpadding="10">
<tr>
<td colspan="2"><input type="text" size="50" name="judul" style="padding:5px; font-size:12px;" placeholder="Ketikkan judul thread..." required /></td>
</tr>
