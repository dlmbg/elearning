...
echo"<table class='widget' style='border: 1pt ridge #DDDDDD;' bgcolor='#fff' ><tr><td><h2><a href='".base_url()."index.php/learning/detailberita/".$row->id_berita."'>".$row->judul_berita."</a></h2>
