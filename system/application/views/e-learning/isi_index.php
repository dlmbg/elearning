...
<table style='border: 1pt ridge #DDDDDD;' bgcolor='#fff' class='widget' width='230' height='200'>
<tr><td bgcolor='#eee' height='32' valign='top' align='center'><b><a href='".base_url()."index.php/learning/detailtutorial/".$tutorial['id_tutorial']."'><h4>".$tutorial['judul_tutorial']."</h4></b></td></tr>
...
<tr><td bgcolor='#eee' align='center'><b><a href='".base_url()."index.php/learning/detailtutorial/".$tutorial['id_tutorial']."'>[Baca Selengkapnya]</a></b></td></tr>
</table>
</div>";
}
echo"</div>";
...
$ptng_isi=nl2br($isi);
echo"<table style='border: 1pt ridge #DDDDDD;' bgcolor='#fff' class='widget' width='470' height='60'>
...
?>
<table style="border: 1pt ridge #DDDDDD;" width="470" bgcolor="#fff" cellpadding="5" class="widget">
<tr bgcolor="#eee"><td colspan="3"><img src="<?php echo base_url(); ?>system/application/views/e-learning/images/pict-index.png" class="image-index"/> <b><a href="<?php echo base_url(); ?>index.php/learning/pengumuman/">Lihat Semua Pengumuman</b></td></tr>
</table>
</div>
