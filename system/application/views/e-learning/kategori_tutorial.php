...
echo"<table class='widget' style='border: 1pt ridge #DDDDDD;' bgcolor='#fff' ><tr><td><h2><a href='".base_url()."index.php/learning/detailtutorial/".$row->id_tutorial."'>".$row->judul_tutorial."</a></h2>
