...
<table style="border: 1pt ridge #DDDDDD;" bgcolor="#fff" width="230" class="widget">
<tr bgcolor="#eee"><td colspan="3"><h2><img src="<?php echo base_url(); ?>system/application/views/e-learning/images/search-icon.png" /> Cari Sesuatu</h2></td></tr>
...
<table style="border: 1pt ridge #DDDDDD;" bgcolor="#fff" width="230" class="widget">
<tr bgcolor="#eee"><td colspan="3"><h2><img src="<?php echo base_url(); ?>system/application/views/e-learning/images/forgot-icon.png" /> Polling Bulan Ini</h2></td></tr>
<?php
...
?>
<tr><td colspan="3" align="center"><br /><input type="submit" value="Pilih dan Vote" class="tombol"/><br>
	<a href="<?php echo base_url(); ?>index.php/learning/lihathasil"><div class="menu-button"><b>Lihat Hasil Polling</b></div></a></td></tr>
</table>
</form>

<table style="border: 1pt ridge #DDDDDD;" width="230" bgcolor="#fff" cellpadding="5" class="widget">
<tr bgcolor="#eee"><td colspan="3"><h2><img src="<?php echo base_url(); ?>system/application/views/e-learning/images/berita-top-icon.png" /> Tutorial Terpopuler</h2></td></tr>
<tr><td>
<ul>
<?php
...
<br>
<table style="border: 1pt ridge #DDDDDD;" width="230" bgcolor="#fff" cellpadding="5" class="widget">
<tr bgcolor="#eee"><td colspan="3"><h2><img src="<?php echo base_url(); ?>system/application/views/e-learning/images/hubungi-icon.png" /> Hubungi Admin</h2></td></tr>
<tr><td>
<ul>
