...
<?php
	...
	foreach($query->result() as $kat)
	{
		...
		echo "<tr bgcolor='".$warna."'><td align='center'>".$nomor."</td><td align='center'>".$kat->kode_mk."</td><td><a href='".base_url()."index.php/dosen/lihatsoal/".$kat->id_matkul."'>"
