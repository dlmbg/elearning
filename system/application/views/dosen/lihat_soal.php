...
<?php
	...
	foreach($query->result() as $kat)
	{
		...
		echo "<tr bgcolor='".$warna."'><td width='20' align='center'>".$nomor."</td><td width='460'><a href='".base_url()."index.php/dosen/daftar_soal/".$kat->id_matkul."/".$kat->no_soal."'>Soal  ".$nomor.
		" ".$kat->nama_mk."</a></td><td><img src='".base_url()."system/application/views/e-learning/images/bullet.gif'> <a href='".base_url()."index.php/dosen/daftar_soal/".$kat->id_matkul."/".$kat->no_soal."'>[ Detail soal ]</a></td></tr>";
		$nomor++;
	}
?>
</table><br />
